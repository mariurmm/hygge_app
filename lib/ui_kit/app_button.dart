...
class AppButton extends StatelessWidget {
  ...
  const AppButton.primary({super.key, required this.text, required this.onPressed, this.isLoading = false})
  ...
  const AppButton.secondary({super.key, required this.text, required this.onPressed, this.isLoading = false})
  ...
  const AppButton.text({super.key, required this.text, required this.onPressed, this.isLoading = false})
  ...
  const AppButton.danger({super.key, required this.text, required this.onPressed, this.isLoading = false})
    ...
    switch (_variant) {
      case _AppButtonVariant.primary:
        return ElevatedButton(
          ...
          child: isLoading ? loadingIndicator(colorScheme.onPrimary) : Text(text),
        );

      case _AppButtonVariant.secondary:
        return OutlinedButton(
          onPressed: effectiveOnPressed,
          child: isLoading ? loadingIndicator(colorScheme.primary) : Text(text),
        );
      ...
      case _AppButtonVariant.danger:
        return ElevatedButton(
          ...
          child: isLoading ? loadingIndicator(colorScheme.onError) : Text(text),
        );
    }
  }
}
