...
class ProfileAccountSubscriptionCard extends StatelessWidget {
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(loc.profileAccountTitle, style: AppTextStyles.scheduleCardTitle),
                        const SizedBox(height: AppSpacings.profileAccountTitleDescGap),
                        SizedBox(
                  ...
                  Positioned(
                    ...
                    top: 0,
                    bottom: 0,
                    child: Center(child: _assetOrIcon(AssetPaths.profileAccountArrow, 24, Icons.chevron_right_rounded)),
                  ),
                ],
              ),
            ),
  ...
  Widget _assetOrIcon(String path, double size, IconData fallback) {
    return Image.asset(
      ...
      height: size,
      fit: BoxFit.contain,
      errorBuilder: (_, __, ___) => Icon(fallback, color: Colors.white, size: size),
    );
  }
}
