...
@LazySingleton(as: ProfileAboutRepository)
class ProfileAboutRepositoryImpl
    with RepositoryExecutorMixin
    implements ProfileAboutRepository {
  ProfileAboutRepositoryImpl({required FirebaseFirestore firestore})
