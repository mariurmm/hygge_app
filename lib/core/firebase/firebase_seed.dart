    ...
    final lessons = <Map<String, dynamic>>[
      {
        ...
        'programId': programId,
        'masterId': masterId,
        'startDate': Timestamp.fromDate(DateTime(2026, 5, 17, 8)),
        'finishDate': Timestamp.fromDate(DateTime(2026, 5, 17, 9)),
        'isBookable': true,
      },
      {
        ...
        'programId': programId,
        'masterId': masterId,
        'startDate': Timestamp.fromDate(DateTime(2026, 5, 11, 8)),
        'finishDate': Timestamp.fromDate(DateTime(2026, 5, 11, 9)),
        'isBookable': true,
      },
      {
        ...
        'programId': programId,
        'masterId': masterId,
        'startDate': Timestamp.fromDate(DateTime(2026, 5, 12, 10)),
        'finishDate': Timestamp.fromDate(DateTime(2026, 5, 12, 11)),
        'isBookable': true,
      },
    ];
